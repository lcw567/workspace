...
//		response.getWriter().print(jArr);
		...
		list.add(new Member(2, "이개똥", "01011112222"));
		list.add(new Member(3, "박개똥", "01011112222"));
		list.add(new Member(4, "린개똥", "01011112222"));
		list.add(new Member(5, "마크개똥", "01011112222"));
		list.add(new Member(6, "엘리자베스개똥", "01011112222"));
