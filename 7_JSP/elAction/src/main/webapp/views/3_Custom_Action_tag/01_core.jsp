...
<body>
	...
	<%
		...
		list.add(new Person("김길동", 20, "여자"));
		list.add(new Person("이길동", 15, "남자"));
	%>
	...
	<pre>
		...
		-구분자를 통해서 분리된 각각의 문자열에 순차적을 접근하면서 반복수행
		-JAVA의 문자열.split("구분자")과 비슷
	</pre>
	
	<c:set var="device" value="컴퓨터,노트북/핸드폰.냉장고" />
	...
	<h3>6. url쿼리스트림</h3>
	<pre>
		-url경로를 생성하고, 쿼리스트림을 정의해둘 수 있는 태그
